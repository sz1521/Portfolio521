  ...
  render() {
    return (
      <article id="dev">
        ...
        <p>Currently I am working with different projects as an UX developer (inc. some backend work): corporate web sites, web applications (inc. AI and resource management).</p>       

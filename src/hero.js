        ...
        <div>
          ...
          <div id="heroContent">
            ...
            <p>
              ...
              <strong>coding</strong> very usable applications (front end to
              back end), <strong>designing</strong> great user experiences
              and/or making things happen in product management and other agile
              roles.
            </p>
            <p>
              To keep on being curious about new things and always learning.
            </p>
            <h3>About me</h3>
            <p>
              I am living in Oulu, Finland, where I moved in 2001 after
              finishing my computer science studies in Joensuu (1995-2000). I am
              born in Kajaani. My hobbies are{" "}
            ...
            <p className="tags">
              ...
              scrum, scm, lead, use cases, user stories, Photoshop, Sketch,
              html, css, Angular, React, UI graphics, visual styles, application

    ...
    return (
      <article id="ux">
        ...
        <p>
          ...
          <strong>desktop</strong>, <strong>web</strong>,{" "}
          <strong>mobile</strong>), I want to provide the best user experience
        ...
        <p>
          I also have a strong graphic design experience. I am also very
          motivated in working with agile, scrum projects and coaching my team
          in a role of Scrum Master.
        </p>
        <p>
          My longest work was participating in very large health care
          information system work by making designs and giving guidance for tens
          of products at once. New products and features are coming in very
          fast-paced all the time and I really needed to use my talent of
          understanding new things fast.
        </p>
        ...
        <ul>
          <li>
            ...
            <strong>use cases</strong> and <strong>user research</strong> as
            input for design
          </li>
          <li>
          ...
          <li>
            ...
            <strong>light prototypes</strong> (local or online, Sketch /
            Invision)
          </li>
          <li>
        ...
        <ul>
          <li>
            <strong>UX review </strong>after a feature specification is ready
            for approving
          </li>
        ...
        <ul>
          <li>
            <strong>Telecom</strong>: Nokia (network admins, mobile phone

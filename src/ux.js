    ...
    render() {
        return (
            <article id="ux">
                ...
                <p>I also have a strong graphic design experience. I am also very motived in working with agile, scrum projects and couching my team in a role of Scrum Master.</p>
                <p>My longest work was participating in very large health care information system work by making designs and giving guidance for tens of products at once. New products and features are coming in very fast-pased all the time and I really needed to use my talent of understanding new things fast.</p>
